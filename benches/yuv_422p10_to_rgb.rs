//! Per-row YUV 4:2:2 10-bit planar → packed RGB throughput baseline.
//!
//! Yuv422p10 shares its per-row kernel with Yuv420p10 — 4:2:2 only
//! changes the vertical walker. Numerically identical output to the
//! Yuv420p10 bench at the same width.
...
fn bench(c: &mut Criterion) {
  ...
  let mut group_u8 = c.benchmark_group("yuv422p10_to_rgb_row");
  ...
  let mut group_u16 = c.benchmark_group("yuv422p10_to_rgb_u16_row");
