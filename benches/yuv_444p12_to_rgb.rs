//! Per-row YUV 4:4:4 12-bit planar → packed RGB throughput baseline.
...
use colconv::{
  ColorMatrix,
  row::{yuv444p12_to_rgb_row, yuv444p12_to_rgb_u16_row},
};
...
fn bench(c: &mut Criterion) {
  ...
  let mut group_u8 = c.benchmark_group("yuv444p12_to_rgb_row");
  ...
  let mut group_u16 = c.benchmark_group("yuv444p12_to_rgb_u16_row");
