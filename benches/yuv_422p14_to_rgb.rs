//! Per-row YUV 4:2:2 14-bit planar → packed RGB throughput baseline.
//!
//! Yuv422p14 shares its per-row kernel with Yuv420p14. 4:2:2 only
...
fn bench(c: &mut Criterion) {
  ...
  let mut group_u8 = c.benchmark_group("yuv422p14_to_rgb_row");
  ...
  let mut group_u16 = c.benchmark_group("yuv422p14_to_rgb_u16_row");
