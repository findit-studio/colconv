//! Per-row YUV 4:2:2 12-bit planar → packed RGB throughput baseline.
//!
//! Yuv422p12 shares its per-row kernel with Yuv420p12. 4:2:2 only
...
fn bench(c: &mut Criterion) {
  ...
  let mut group_u8 = c.benchmark_group("yuv422p12_to_rgb_row");
  ...
  let mut group_u16 = c.benchmark_group("yuv422p12_to_rgb_u16_row");
