//! Per-row YUV 4:4:4 14-bit planar → packed RGB throughput baseline.
...
fn bench(c: &mut Criterion) {
  ...
  let mut group_u8 = c.benchmark_group("yuv444p14_to_rgb_row");
  ...
  let mut group_u16 = c.benchmark_group("yuv444p14_to_rgb_u16_row");
