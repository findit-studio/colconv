...
use colconv::{
  ColorMatrix,
  row::{yuv444p10_to_rgb_row, yuv444p10_to_rgb_u16_row},
};
...
fn bench(c: &mut Criterion) {
  ...
  let mut group_u8 = c.benchmark_group("yuv444p10_to_rgb_row");
  ...
  let mut group_u16 = c.benchmark_group("yuv444p10_to_rgb_u16_row");
