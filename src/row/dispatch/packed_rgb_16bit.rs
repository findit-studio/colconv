...
pub fn rgb48_to_rgb_row(rgb48: &[u16], rgb_out: &mut [u8], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_rgb48_to_rgb_row(rgb48, rgb_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn rgb48_to_rgba_row(rgb48: &[u16], rgba_out: &mut [u8], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_rgb48_to_rgba_row(rgb48, rgba_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn rgb48_to_rgb_u16_row(rgb48: &[u16], rgb_out: &mut [u16], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_rgb48_to_rgb_u16_row(rgb48, rgb_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn rgb48_to_rgba_u16_row(rgb48: &[u16], rgba_out: &mut [u16], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_rgb48_to_rgba_u16_row(rgb48, rgba_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn bgr48_to_rgb_row(bgr48: &[u16], rgb_out: &mut [u8], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_bgr48_to_rgb_row(bgr48, rgb_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn bgr48_to_rgba_row(bgr48: &[u16], rgba_out: &mut [u8], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_bgr48_to_rgba_row(bgr48, rgba_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn bgr48_to_rgb_u16_row(bgr48: &[u16], rgb_out: &mut [u16], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_bgr48_to_rgb_u16_row(bgr48, rgb_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn bgr48_to_rgba_u16_row(bgr48: &[u16], rgba_out: &mut [u16], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_bgr48_to_rgba_u16_row(bgr48, rgba_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn rgba64_to_rgb_row(rgba64: &[u16], rgb_out: &mut [u8], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_rgba64_to_rgb_row(rgba64, rgb_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn rgba64_to_rgba_row(rgba64: &[u16], rgba_out: &mut [u8], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_rgba64_to_rgba_row(rgba64, rgba_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn rgba64_to_rgb_u16_row(rgba64: &[u16], rgb_out: &mut [u16], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_rgba64_to_rgb_u16_row(rgba64, rgb_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn rgba64_to_rgba_u16_row(rgba64: &[u16], rgba_out: &mut [u16], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_rgba64_to_rgba_u16_row(rgba64, rgba_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn bgra64_to_rgb_row(bgra64: &[u16], rgb_out: &mut [u8], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_bgra64_to_rgb_row(bgra64, rgb_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn bgra64_to_rgba_row(bgra64: &[u16], rgba_out: &mut [u8], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_bgra64_to_rgba_row(bgra64, rgba_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn bgra64_to_rgb_u16_row(bgra64: &[u16], rgb_out: &mut [u16], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_bgra64_to_rgb_u16_row(bgra64, rgb_out, width); }
          return;
        }
        if avx2_available() {
...
pub fn bgra64_to_rgba_u16_row(bgra64: &[u16], rgba_out: &mut [u16], width: usize, use_simd: bool) {
  ...
  if use_simd {
    cfg_select! {
      ...
      target_arch = "x86_64" => {
        if avx512_available() {
          unsafe { arch::x86_avx512::avx512_bgra64_to_rgba_u16_row(bgra64, rgba_out, width); }
          return;
        }
        if avx2_available() {
