...
pub(crate) unsafe fn gbr_to_rgb_high_bit_row<const BITS: u32>(
  ...
  unsafe {
    ...
    let mut x = 0usize;
    while x + 16 <= width {
      let r_v = _mm256_loadu_si256(r.as_ptr().add(x).cast());
      let g_v = _mm256_loadu_si256(g.as_ptr().add(x).cast());
      let b_v = _mm256_loadu_si256(b.as_ptr().add(x).cast());
...
pub(crate) unsafe fn gbra_to_rgba_high_bit_row<const BITS: u32>(
  ...
  unsafe {
    ...
    while x + 16 <= width {
      ...
      let g_v = _mm256_loadu_si256(g.as_ptr().add(x).cast());
      let b_v = _mm256_loadu_si256(b.as_ptr().add(x).cast());
      let a_v = _mm256_loadu_si256(a.as_ptr().add(x).cast());
...
pub(crate) unsafe fn gbr_to_rgb_u16_high_bit_row<const BITS: u32>(
  ...
  unsafe {
    ...
    while x + 16 <= width {
      ...
      let r_hi = _mm_loadu_si128(r.as_ptr().add(x + 8).cast());
      let g_hi = _mm_loadu_si128(g.as_ptr().add(x + 8).cast());
      let b_hi = _mm_loadu_si128(b.as_ptr().add(x + 8).cast());
...
pub(crate) unsafe fn gbra_to_rgba_u16_high_bit_row<const BITS: u32>(
  ...
  unsafe {
    ...
    while x + 16 <= width {
      ...
      let g_hi = _mm_loadu_si128(g.as_ptr().add(x + 8).cast());
      let b_hi = _mm_loadu_si128(b.as_ptr().add(x + 8).cast());
      let a_hi = _mm_loadu_si128(a.as_ptr().add(x + 8).cast());
      write_rgba_u16_8(
        r_hi,
        g_hi,
        b_hi,
