...
// ---- BE parity: AVX2<BITS, true> on BE-encoded storage must match -------
// AVX2<BITS, false> on LE-encoded storage. Each plane is built from the ----
...
fn avx2_gbr_to_rgb_high_bit_be_matches_le_bits10() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "AVX2 gbr_to_rgb_high_bit<10> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
...
fn avx2_gbr_to_rgb_high_bit_be_matches_le_bits16() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "AVX2 gbr_to_rgb_high_bit<16> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
      "AVX2 gbr_to_rgb_high_bit BE/LE mismatch (w={w})"
...
fn avx2_gbr_to_rgba_opaque_high_bit_be_matches_le_bits10() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "AVX2 gbr_to_rgba_opaque_high_bit<10> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
...
fn avx2_gbr_to_rgba_opaque_high_bit_be_matches_le_bits16() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "AVX2 gbr_to_rgba_opaque_high_bit<16> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
      "AVX2 gbr_to_rgba_opaque_high_bit BE/LE mismatch (w={w})"
...
fn avx2_gbra_to_rgba_high_bit_be_matches_le_bits10() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "AVX2 gbra_to_rgba_high_bit<10> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
...
fn avx2_gbra_to_rgba_high_bit_be_matches_le_bits16() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "AVX2 gbra_to_rgba_high_bit<16> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
      "AVX2 gbra_to_rgba_high_bit BE/LE mismatch (w={w})"
...
fn avx2_gbr_to_rgb_u16_high_bit_be_matches_le_bits10() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "AVX2 gbr_to_rgb_u16_high_bit<10> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
...
fn avx2_gbr_to_rgb_u16_high_bit_be_matches_le_bits16() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "AVX2 gbr_to_rgb_u16_high_bit<16> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
      "AVX2 gbr_to_rgb_u16_high_bit BE/LE mismatch (w={w})"
...
fn avx2_gbr_to_rgba_opaque_u16_high_bit_be_matches_le_bits10() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "AVX2 gbr_to_rgba_opaque_u16_high_bit<10> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
...
fn avx2_gbr_to_rgba_opaque_u16_high_bit_be_matches_le_bits16() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "AVX2 gbr_to_rgba_opaque_u16_high_bit<16> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
      "AVX2 gbr_to_rgba_opaque_u16_high_bit BE/LE mismatch (w={w})"
...
fn avx2_gbra_to_rgba_u16_high_bit_be_matches_le_bits10() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "AVX2 gbra_to_rgba_u16_high_bit<10> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
...
fn avx2_gbra_to_rgba_u16_high_bit_be_matches_le_bits16() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "AVX2 gbra_to_rgba_u16_high_bit<16> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
      "AVX2 gbra_to_rgba_u16_high_bit BE/LE mismatch (w={w})"
