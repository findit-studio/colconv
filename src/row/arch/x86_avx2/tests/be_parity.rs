...
use super::{high_bit_plane_avx2, interleave_uv_avx2, p_n_packed_plane, p010_uv_interleave};
...
#[cfg(feature = "rgb")]
#[test]
fn avx2_x2rgb10_to_rgb_be_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx2") {
    return;
  }
  for w in [1usize, 7, 31, 32, 33, 63, 64, 65, 1920, 1921] {
    ...
    assert_eq!(
      out_scalar, out_simd,
      "AVX2 x2rgb10_to_rgb<BE> diverges (width={w})"
    );
  }
}
...
#[cfg(feature = "rgb")]
#[test]
fn avx2_x2rgb10_to_rgba_be_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx2") {
    return;
  }
  for w in [1usize, 7, 31, 32, 33, 63, 64, 65, 1920, 1921] {
    ...
    assert_eq!(
      out_scalar, out_simd,
      "AVX2 x2rgb10_to_rgba<BE> diverges (width={w})"
    );
  }
}
...
#[cfg(feature = "rgb")]
#[test]
fn avx2_x2rgb10_to_rgb_u16_be_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx2") {
    return;
  }
  for w in [1usize, 7, 15, 16, 17, 31, 32, 33, 1920, 1921] {
    ...
    assert_eq!(
      out_scalar, out_simd,
      "AVX2 x2rgb10_to_rgb_u16<BE> diverges (width={w})"
    );
  }
}
...
#[cfg(feature = "rgb")]
#[test]
fn avx2_x2bgr10_to_rgb_be_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx2") {
    return;
  }
  for w in [1usize, 7, 31, 32, 33, 63, 64, 65, 1920, 1921] {
    ...
    assert_eq!(
      out_scalar, out_simd,
      "AVX2 x2bgr10_to_rgb<BE> diverges (width={w})"
    );
  }
}
...
#[cfg(feature = "rgb")]
#[test]
fn avx2_x2bgr10_to_rgba_be_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx2") {
    return;
  }
  for w in [1usize, 7, 31, 32, 33, 63, 64, 65, 1920, 1921] {
    ...
    assert_eq!(
      out_scalar, out_simd,
      "AVX2 x2bgr10_to_rgba<BE> diverges (width={w})"
    );
  }
}
...
#[cfg(feature = "rgb")]
#[test]
fn avx2_x2bgr10_to_rgb_u16_be_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx2") {
    return;
  }
  for w in [1usize, 7, 15, 16, 17, 31, 32, 33, 1920, 1921] {
    ...
    assert_eq!(
      out_scalar, out_simd,
      "AVX2 x2bgr10_to_rgb_u16<BE> diverges (width={w})"
    );
  }
}
