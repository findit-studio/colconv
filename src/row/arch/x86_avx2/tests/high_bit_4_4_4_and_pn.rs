...
// AVX2 RGBA kernel byte-pinned against the scalar reference at the
// natural width and a sweep of tail widths. Each test gates on
// `is_x86_feature_detected!("avx2")` to stay clean under
