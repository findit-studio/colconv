...
///
/// wasm u16-RGB path threshold: 8 px/iter. W=16 covers 2 full iterations.
/// No runtime feature guard — simd128 is a compile-time feature on wasm.
...
fn wasm_simd128_y216_lane_order_per_pixel_y_and_u() {
  const W: usize = 16;
  ...
  assert_eq!(
    ...
    "wasm_simd128 y216 luma_u16 reorder bug"
  );
  ...
  assert_eq!(
    simd_rgb, scalar_rgb,
    "wasm_simd128 y216 SIMD vs scalar diverges (u16 RGB, i64 chroma)"
  );
}
