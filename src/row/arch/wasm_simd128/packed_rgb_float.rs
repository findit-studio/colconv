...
// ---- Tier 9 — Rgbaf32 wasm-simd128 entry points (4-channel, real alpha) -----------
//
...
///
/// # Safety
/// wasm-simd128 available; `rgba_in.len() >= 4*width`, `rgb_out.len() >= 3*width`,
/// no aliasing.
#[inline]
#[target_feature(enable = "simd128")]
...
///
/// # Safety
/// wasm-simd128 available; `rgba_in.len() >= 4*width`, `rgba_out.len() >= 4*width`,
/// no aliasing.
#[inline]
#[target_feature(enable = "simd128")]
...
// ---- Tier 9 — Rgbaf16 wasm-simd128 entry points (4-channel, real alpha) -----------
//
