...
// ---- Tier 9 — Rgbaf32 AVX-512 entry points (4-channel, real alpha) -----------
//
...
///
/// # Safety
/// AVX-512 available; `rgba_in.len() >= 4*width`, `rgb_out.len() >= 3*width`,
/// no aliasing.
#[inline]
#[target_feature(enable = "avx512f,avx512bw")]
...
///
/// # Safety
/// AVX-512 available; `rgba_in.len() >= 4*width`, `rgba_out.len() >= 4*width`,
/// no aliasing.
#[inline]
#[target_feature(enable = "avx512f,avx512bw")]
...
// ---- Tier 9 — Rgbaf16 AVX-512 entry points (4-channel, real alpha) -----------
//
