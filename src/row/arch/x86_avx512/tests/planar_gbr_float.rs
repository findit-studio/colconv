...
// All tests in this file are for x86_64 AVX-512F + BW. Each test must call
// `is_x86_feature_detected!("avx512bw")` (which implies avx512f) and
// early-return when not available, so CI sanitizer / Miri on non-x86 hosts
// does not trip.
//
