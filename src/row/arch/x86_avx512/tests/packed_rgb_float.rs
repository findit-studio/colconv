...
// ---- Tier 9 Rgbf16 AVX-512 + F16C parity tests ------------------------------
...
#[test]
fn avx512_rgbaf32_matches_scalar_all_outputs() {
  if !std::arch::is_x86_feature_detected!("avx512bw") {
    return;
  }
...
#[test]
fn avx512_rgbaf16_matches_scalar_all_outputs() {
  if !std::arch::is_x86_feature_detected!("avx512bw")
    || !std::arch::is_x86_feature_detected!("f16c")
  {
    return;
...
#[test]
fn avx512_rgbaf16_f16_passthrough_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx512bw") {
    return;
  }
  for w in RGBA_WIDTHS {
