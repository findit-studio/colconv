//! AVX-512 parity tests for the Tier 12 (DCP / Xyz12) kernels.
//!
...
//! `oetf_srgb` polynomial) and early-returns when AVX-512F is
//! unavailable on the host (sanitizer / CI safety).

use super::super::*;
use crate::{
  DcpTargetGamut,
  row::arch::x86_avx512::xyz12::{
...
fn avx512_xyz12_to_rgb_matches_scalar() {
  ...
  for &w in WIDTHS {
    for gamut in [
      ...
      assert_eq!(
        out_scalar, out_avx,
        "AVX-512 xyz12_to_rgb diverges (w={w}, gamut={gamut:?})"
      );
    }
  }
}
...
#[test]
#[cfg_attr(miri, ignore = "x86 AVX-512 SIMD intrinsics unsupported by Miri")]
fn avx512_xyz12_to_rgb_dirty_input_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx512f")
    || !std::arch::is_x86_feature_detected!("avx512bw")
  {
    return;
  ...
  for &w in WIDTHS {
    ...
    assert_eq!(
      out_scalar, out_avx,
      "AVX-512 xyz12_to_rgb dirty-input diverges (w={w})"
    );
  }
}
...
#[test]
#[cfg_attr(miri, ignore = "x86 AVX-512 SIMD intrinsics unsupported by Miri")]
fn avx512_xyz12_to_rgb_be_matches_le() {
  if !std::arch::is_x86_feature_detected!("avx512f")
    || !std::arch::is_x86_feature_detected!("avx512bw")
  {
    return;
  ...
  for &w in WIDTHS {
    ...
    assert_eq!(
      out_le, out_be,
      "AVX-512 xyz12_to_rgb BE/LE mismatch (w={w})"
    );
  }
}
...
#[test]
#[cfg_attr(miri, ignore = "x86 AVX-512 SIMD intrinsics unsupported by Miri")]
fn avx512_xyz12_to_rgba_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx512f")
    || !std::arch::is_x86_feature_detected!("avx512bw")
  {
    return;
  ...
  for &w in WIDTHS {
    ...
    assert_eq!(
      out_scalar, out_avx,
      "AVX-512 xyz12_to_rgba diverges (w={w})"
    );
  }
}
...
#[test]
#[cfg_attr(miri, ignore = "x86 AVX-512 SIMD intrinsics unsupported by Miri")]
fn avx512_xyz12_to_rgb_u16_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx512f")
    || !std::arch::is_x86_feature_detected!("avx512bw")
  {
    return;
  ...
  for &w in WIDTHS {
    ...
    assert_eq!(
      out_scalar, out_avx,
      "AVX-512 xyz12_to_rgb_u16 diverges (w={w})"
    );
  }
}
...
#[test]
#[cfg_attr(miri, ignore = "x86 AVX-512 SIMD intrinsics unsupported by Miri")]
fn avx512_xyz12_to_rgba_u16_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx512f")
    || !std::arch::is_x86_feature_detected!("avx512bw")
  {
    return;
  ...
  for &w in WIDTHS {
    ...
    assert_eq!(
      out_scalar, out_avx,
      "AVX-512 xyz12_to_rgba_u16 diverges (w={w})"
    );
  }
}
...
#[test]
#[cfg_attr(miri, ignore = "x86 AVX-512 SIMD intrinsics unsupported by Miri")]
fn avx512_xyz12_to_rgb_f32_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx512f")
    || !std::arch::is_x86_feature_detected!("avx512bw")
  {
    return;
  ...
  for &w in WIDTHS {
    ...
    assert_eq!(
      out_scalar, out_avx,
      "AVX-512 xyz12_to_rgb_f32 diverges (w={w})"
    );
  }
}
...
#[test]
#[cfg_attr(miri, ignore = "x86 AVX-512 SIMD intrinsics unsupported by Miri")]
fn avx512_xyz12_to_xyz_f32_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx512f")
    || !std::arch::is_x86_feature_detected!("avx512bw")
  {
    return;
  ...
  for &w in WIDTHS {
    ...
    assert_eq!(
      out_scalar, out_avx,
      "AVX-512 xyz12_to_xyz_f32 diverges (w={w})"
    );
  }
}
...
#[test]
#[cfg_attr(miri, ignore = "x86 AVX-512 SIMD intrinsics unsupported by Miri")]
fn avx512_xyz12_to_rgb_f16_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx512f")
    || !std::arch::is_x86_feature_detected!("avx512bw")
  {
    return;
  ...
  for &w in WIDTHS {
    ...
    assert_eq!(
      out_scalar, out_avx,
      "AVX-512 xyz12_to_rgb_f16 diverges (w={w})"
    );
  }
}
...
#[test]
#[cfg_attr(miri, ignore = "x86 AVX-512 SIMD intrinsics unsupported by Miri")]
fn avx512_xyz12_to_rgba_f16_matches_scalar() {
  if !std::arch::is_x86_feature_detected!("avx512f")
    || !std::arch::is_x86_feature_detected!("avx512bw")
  {
    return;
  ...
  for &w in WIDTHS {
    ...
    assert_eq!(
      out_scalar, out_avx,
      "AVX-512 xyz12_to_rgba_f16 diverges (w={w})"
    );
  }
}
