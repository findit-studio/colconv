...
// ---- BE parity: SSE4.1<BITS, true> on BE-encoded storage must match -------
// SSE4.1<BITS, false> on LE-encoded storage. Each plane is built from the ----
...
fn sse41_gbr_to_rgb_high_bit_be_matches_le_bits10() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "SSE4.1 gbr_to_rgb_high_bit<10> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
...
fn sse41_gbr_to_rgb_high_bit_be_matches_le_bits16() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "SSE4.1 gbr_to_rgb_high_bit<16> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
      "SSE4.1 gbr_to_rgb_high_bit BE/LE mismatch (w={w})"
...
fn sse41_gbr_to_rgba_opaque_high_bit_be_matches_le_bits10() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "SSE4.1 gbr_to_rgba_opaque_high_bit<10> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
...
fn sse41_gbr_to_rgba_opaque_high_bit_be_matches_le_bits16() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "SSE4.1 gbr_to_rgba_opaque_high_bit<16> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
      "SSE4.1 gbr_to_rgba_opaque_high_bit BE/LE mismatch (w={w})"
...
fn sse41_gbra_to_rgba_high_bit_be_matches_le_bits10() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "SSE4.1 gbra_to_rgba_high_bit<10> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
...
fn sse41_gbra_to_rgba_high_bit_be_matches_le_bits16() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "SSE4.1 gbra_to_rgba_high_bit<16> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
      "SSE4.1 gbra_to_rgba_high_bit BE/LE mismatch (w={w})"
...
fn sse41_gbr_to_rgb_u16_high_bit_be_matches_le_bits10() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "SSE4.1 gbr_to_rgb_u16_high_bit<10> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
...
fn sse41_gbr_to_rgb_u16_high_bit_be_matches_le_bits16() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "SSE4.1 gbr_to_rgb_u16_high_bit<16> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
      "SSE4.1 gbr_to_rgb_u16_high_bit BE/LE mismatch (w={w})"
...
fn sse41_gbr_to_rgba_opaque_u16_high_bit_be_matches_le_bits10() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "SSE4.1 gbr_to_rgba_opaque_u16_high_bit<10> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
...
fn sse41_gbr_to_rgba_opaque_u16_high_bit_be_matches_le_bits16() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "SSE4.1 gbr_to_rgba_opaque_u16_high_bit<16> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
      "SSE4.1 gbr_to_rgba_opaque_u16_high_bit BE/LE mismatch (w={w})"
...
fn sse41_gbra_to_rgba_u16_high_bit_be_matches_le_bits10() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "SSE4.1 gbra_to_rgba_u16_high_bit<10> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
...
fn sse41_gbra_to_rgba_u16_high_bit_be_matches_le_bits16() {
  ...
  for w in [1usize, 7, 8, 16, 17, 32, 33, 64, 128, 130] {
    ...
    assert_eq!(
      out_le, expected,
      "SSE4.1 gbra_to_rgba_u16_high_bit<16> LE output != reference (w={w})"
    );
    assert_eq!(
      out_le, out_be,
      "SSE4.1 gbra_to_rgba_u16_high_bit BE/LE mismatch (w={w})"
