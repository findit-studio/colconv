...
pub(crate) unsafe fn x2rgb10_to_rgb_row<const BE: bool>(
  ...
  unsafe {
    let mut x = 0usize;
    while x + 16 <= width {
      x2rgb10_to_rgb_16_pixels::<BE>(x2rgb10.as_ptr().add(x * 4), rgb_out.as_mut_ptr().add(x * 3));
      x += 16;
    }
    if x < width {
...
pub(crate) unsafe fn x2rgb10_to_rgb_u16_row<const BE: bool>(
  ...
  unsafe {
    let mut x = 0usize;
    while x + 8 <= width {
      x2rgb10_to_rgb_u16_8_pixels::<BE>(
        x2rgb10.as_ptr().add(x * 4),
...
pub(crate) unsafe fn x2bgr10_to_rgb_row<const BE: bool>(
  ...
  unsafe {
    let mut x = 0usize;
    while x + 16 <= width {
      x2bgr10_to_rgb_16_pixels::<BE>(x2bgr10.as_ptr().add(x * 4), rgb_out.as_mut_ptr().add(x * 3));
      x += 16;
    }
    if x < width {
...
pub(crate) unsafe fn x2bgr10_to_rgb_u16_row<const BE: bool>(
  ...
  unsafe {
    let mut x = 0usize;
    while x + 8 <= width {
      x2bgr10_to_rgb_u16_8_pixels::<BE>(
        x2bgr10.as_ptr().add(x * 4),
        rgb_out.as_mut_ptr().add(x * 3).cast::<u8>(),
      );
      x += 8;
