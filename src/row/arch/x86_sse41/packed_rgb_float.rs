...
// ---- Tier 9 — Rgbaf32 SSE4.1 entry points (4-channel, real alpha) -----------
//
...
///
/// # Safety
/// SSE4.1 available; `rgba_in.len() >= 4*width`, `rgb_out.len() >= 3*width`,
/// no aliasing.
#[inline]
#[target_feature(enable = "sse4.1")]
...
///
/// # Safety
/// SSE4.1 available; `rgba_in.len() >= 4*width`, `rgba_out.len() >= 4*width`,
/// no aliasing.
#[inline]
#[target_feature(enable = "sse4.1")]
...
// ---- Tier 9 — Rgbaf16 SSE4.1 entry points (4-channel, real alpha) -----------
//
