...
fn rgb565_rgba_buffer_too_short_returns_error() {
  ...
  assert!(
    matches!(result, Err(MixedSinkerError::RgbaBufferTooShort(_))),
...
fn rgb565_rgb_u16_buffer_too_short_returns_error() {
  ...
  assert!(
    matches!(result, Err(MixedSinkerError::RgbU16BufferTooShort(_))),
...
fn rgb565_rgba_u16_buffer_too_short_returns_error() {
  ...
  assert!(
    matches!(result, Err(MixedSinkerError::RgbaU16BufferTooShort(_))),
...
fn rgb565_luma_u16_buffer_too_short_returns_error() {
  ...
  assert!(
    matches!(result, Err(MixedSinkerError::LumaU16BufferTooShort(_))),
