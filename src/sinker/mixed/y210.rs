...
use crate::{
  PixelSink,
  row::{
    expand_rgb_to_rgba_row, expand_rgb_u16_to_rgba_u16_row, rgb_to_hsv_row, y210_to_luma_row,
    y210_to_luma_u16_row, y210_to_rgb_row, y210_to_rgb_u16_row, y210_to_rgba_row,
    y210_to_rgba_u16_row,
  },
  yuv::{Y210, Y210Row, Y210Sink},
};

impl<'a> MixedSinker<'a, Y210> {
...
impl Y210Sink for MixedSinker<'_, Y210> {}

impl PixelSink for MixedSinker<'_, Y210> {
